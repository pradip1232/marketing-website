      ...
      <section>
        <Container fluid className="text-center py-5">
          ...
          <Row className="justify-content-center mb-4">
            <Col md={12}>
              <Button variant="primary" className="rounded-pill px-4 py-2">Reach Out to Us</Button>
            </Col>
          ...
          <Row className="justify-content-center bg-dark text-white py-4" style={{
            ...
            <Col md={4} className="d-flex flex-column align-items-center">
              ...
              <p className="mt-2">Aggarwal Corporate Heights, Netaji Subhash Place,<br />Pitampura, Delhi - 110034</p>
            </Col>
          </Row>
          ...
          <Row className="justify-content-center mt-4">
            ...
            <Col md={12}>
              <FaFacebook size={30} className="mx-2 text-primary" />
              <FaInstagram size={30} className="mx-2 text-danger" />
              <FaTelegram size={30} className="mx-2 text-info" />
